...
/* ---------------- Contractor Cleaning ---------------- */
function ContractorCleaning() {
  const { t } = useT();
  return (
    <section id="contractor" className="scroll-mt-20 border-t border-white/10 bg-[#0a0a0a] px-6 py-20 md:py-28">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:gap-16 items-center">
        <Reveal className="order-2 lg:order-1">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/contract.jpeg" alt="Contractor Cleaning Services" className="w-full h-auto rounded-lg shadow-2xl ring-1 ring-white/10" />
        </Reveal>
        <Reveal className="order-1 lg:order-2 space-y-6">
          <Eyebrow icon={HardHat}>{t("contractor.eyebrow")}</Eyebrow>
          <h2 className="font-serif text-[clamp(1.75rem,3.8vw,2.5rem)] leading-[1.08] tracking-tight text-white">
            {t("contractor.h")}
          </h2>
